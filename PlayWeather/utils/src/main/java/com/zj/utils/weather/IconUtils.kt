...
object IconUtils {
     ...
     * @return 天气icon
     */
    fun getWeatherAnimationIcon(context: Context?, weather: String?, isDay: Boolean? = null): Int {
        if (context == null || weather == null) return R.raw.weather_sun
        return if (isDay ?: !context.isDarkMode()) {
     ...
     * @return 天气icon
     */
    fun getWeatherBack(context: Context?, weather: String?, isDay: Boolean? = null): Int {
     ...
     * @return 天气icon
     */
    fun getWeatherIcon(weather: String?, context: Context? = null, isDay: Boolean? = null): Int {
        if (weather == null) return R.drawable.x_sunny
        val day = isDay ?: if (context != null) {
            !context.isDarkMode()
        } else {
            true
        }
        return when (weather) {
            "100", "150" -> if (day) R.drawable.x_sunny else R.drawable.x_yewan_qing
            "101", "102", "103", "151", "152", "153" -> if (day) R.drawable.x_cloud else R.drawable.x_cloudy_night
            "104", "154", "200", "201", "202", "203", "204", "205", "206", "207", "208",
            "209", "210", "211", "212", "213" -> R.drawable.x_overcast
            "300", "301" -> if (day) R.drawable.x_shower else R.drawable.x_yejian_zhenyu
            ...
            "456", "457", "499" -> if (day) R.drawable.x_snow_flurry else R.drawable.x_snow_flurry_night
