    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = buildString {
                        append(locationBean?.adm1 ?: "")
                        append(" ")
                        append(locationBean?.adm2 ?: "")
                        locationBean?.country?.let {
                            append(" · ")
                            append(it)
                        }
                    },
                    ...
                    color = if (!hasLocation) Color.Unspecified.copy(alpha = 0.6f) else Color.Gray,
                    fontSize = 13.sp
                )
            }
        }
