...
import com.zj.utils.weather.getSunProgress
...
@Composable
fun SunriseSunsetContent(dailyBean: WeatherDailyBean.DailyBean?, nowTime: String?) {
 ...
 */
@Composable
fun SunriseSunsetProgress(context: Context, nowTime: String?, sunrise: String?, sunset: String?) {
    val result = getSunProgress(nowTime, sunrise, sunset)
